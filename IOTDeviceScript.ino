...
#define DHTPIN 0
// Tipo0 de sensor de temperatura y humedad
...
const char ssid[] = "ESCOBARITO"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Mateus01"; // TODO cambiar por la contraseña de la red WiFi
...
// TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
const char MQTT_HOST[] = "44.202.28.82";
...
const char MQTT_TOPIC_PUB[] = "colombia/huila/neiva/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "colombia/huila/neiva/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
